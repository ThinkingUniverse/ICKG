...
> **使用场景 / 解决的问题**：科研最值钱的是"还没人报道、但很可能成立"的关联。本场景用 KG embedding 在 ICKG 上做链接预测，**预测尚未被文献显式报道的"细胞↔疾病""因子→表型""干预↔适应症"等潜在关联**，输出可排序的"机器生成科学假设"，帮研究者锁定实验与选题的优先级。
...
- 预测"某干预 ↔ 某疾病"的潜在适应症（为新适应症探索提供候选假设）
